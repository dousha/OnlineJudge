...
class UserLoginAPITest(APITestCase):
    ...
    def test_tfa_login_wrong_code(self):
        ...
        self.assertDictEqual(
            response.data,
            {'error': 'error', 'data': 'Invalid two factor verification code'},
        )
...
class UserRegisterAPITest(CaptchaTest):
    ...
    def test_website_config_limit(self):
        ...
        self.assertDictEqual(
            resp.data,
            {'error': 'error', 'data': 'Register function has been disabled by admin'},
        )
...
class ResetPasswordAPITest(CaptchaTest):
    ...
    def test_reset_password_with_invalid_token(self):
        ...
        resp = self.client.post(self.url, data=self.data)
        self.assertDictEqual(
            resp.data, {'error': 'error', 'data': 'Token does not exist'}
        )
...
class OpenAPIAppkeyAPITest(APITestCase):
    ...
    def test_reset_appkey(self):
        ...
        self.assertSuccess(resp)
        self.assertEqual(
            resp.data['data']['appkey'],
            User.objects.get(username=self.user.username).open_api_appkey,
        )
